fileH1i <- "data_2015_june/H1individual.csv"
fileH1a <- "data_2015_june/H1aggregate.csv"
fileCompl <- "data_2015_june/BernaComplete_2011_20150630.csv"
fileRep <- "data_2015_june/BernaRepeatedPair_2011_20150630_BothChannels.csv"
...
tfile  <- "data_2015_june/NewTracesForAmenitiesCounting_only2_clean.csv"
...
chfile <- "data_2015_june/allPreferences.csv"
kw  <- read.csv(kwfile, stringsAsFactor = FALSE, strip.white = TRUE)
